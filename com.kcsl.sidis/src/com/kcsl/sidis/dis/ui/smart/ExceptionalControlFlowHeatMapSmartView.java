 ...
 * @author Ben Holland
 */
public class ExceptionalControlFlowHeatMapSmartView extends FilteringAtlasSmartViewScript implements IResizableScript, IExplorableScript {

	@Override
	public String getTitle() {
		return "Control Flow (Exceptional DIS Heat Map)";
	}
